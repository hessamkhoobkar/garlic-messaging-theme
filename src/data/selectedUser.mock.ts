...
export const selectedUser = {
	...
	chatHistory: [
		{ sender: 'Friend A', text: "Hey, what's up?", date: '2022-01-05 8:32 AM' },
		{
			sender: 'Friend B',
		...
		{ sender: 'Friend B', text: 'Sure, how about Thursday evening?', date: '2022-01-16 5:45 PM' },
		{
			sender: 'Friend A',
		...
		{ sender: 'Friend B', text: 'Hey, how was your day?', date: '2022-02-17 6:25 PM' },
		{
			sender: 'Friend A',
